// Icons.jsx — small inline SVG icon set, no external deps
const Icon = ({ name, size = 16, className = "", strokeWidth = 1.75 }) => {
  const paths = {
    ...
    sparkle: <><path d="M12 3v3m0 12v3M3 12h3m12 0h3m-2.5-7.5L17 6m-10 12l-1.5 1.5M17 18l1.5 1.5m-12-15L7 6"/><circle cx="12" cy="12" r="3"/></>,
